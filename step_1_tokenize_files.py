...
if __name__ == "__main__":    
    ...
    print('Convert MEDDOPROF train set (task 1)')
    ann_path = 'data/train/task1/'
    out_path = 'data/bio/train_task_1/'
    process_files(ann_path, out_path, hf_tokenizer)
    
    print('Convert MEDDOPROF train set (task 2)')
    ann_path = 'data/train/task2/'
    out_path = 'data/bio/train_task_2/'
    process_files(ann_path, out_path, hf_tokenizer)
    
    print('Convert MEDDOPROF test set (task 1)')
    ann_path = 'data/test/ner/'
    out_path = 'data/bio/test_task_1/'
    process_files(ann_path, out_path, hf_tokenizer)
    
    print('Convert MEDDOPROF test set (task 2)')
    ann_path = 'data/test/class/'
    out_path = 'data/bio/test_task_2/'
    process_files(ann_path, out_path, hf_tokenizer)
